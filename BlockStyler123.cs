...
//
//       Filename:  F:\Store\SANEK\Volume\NXOpen\5_ToolHolder\BlockStyler123.cs
//
//        This file was generated by the NX Block UI Styler
//        Created by: Sanek
//              Version: NX 12
//              Date: 05-26-2020  (Format: mm-dd-yyyy)
...
public class BlockStyler123
{
    ...
    //------------------------------------------------------------------------------
    public BlockStyler123()
    {
        try
        {
            theSession = Session.GetSession();
            theUI = UI.GetUI();
            theDlxFileName = "123.dlx";
    ...
    //             BlockStyler123.Show_BlockStyler123();
    ...
    {
        BlockStyler123 theBlockStyler123 = null;
        try
        {
            theBlockStyler123 = new BlockStyler123();
            // The following method shows the dialog immediately
            theBlockStyler123.Show();
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
        ...
        {
            if(theBlockStyler123 != null)
                theBlockStyler123.Dispose();
                theBlockStyler123 = null;
        }
    }
#endif//USER_EXIT_OR_MENU
#if USER_EXIT
...
#if CALLBACK
    //------------------------------------------------------------------------------
    //Method name: Show_BlockStyler123
    //------------------------------------------------------------------------------
    public static void Show_BlockStyler123()
    {
        BlockStyler123 theBlockStyler123 = null;
        try
        {
