...
//
//       Filename:  F:\Store\SANEK\Volume\NXOpen\5_ToolHolder\GUI\secondDialog.cs
//
...
public class secondDialog
{
    ...
    private NXOpen.BlockStyler.IntegerBlock integerToolDiam;// Block type: Integer
    ...
    //             secondDialog.Show_secondDialog();
    ...
    {
        secondDialog thesecondDialog = null;
        try
        {
            thesecondDialog = new secondDialog();
			thesecondDialog._dataService = new DataService(thesecondDialog);
